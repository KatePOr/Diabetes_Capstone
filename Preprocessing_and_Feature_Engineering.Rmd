...
## test code for q-q plot (DELETE)
```{r}
CDC_2023_training1 <- CDC_2023_training
CDC_2023_training1$DIABETE4 <- as.numeric(CDC_2023_training1$DIABETE4)
CDC_2023_training1$DIABETE4 <- log(CDC_2023_training1$DIABETE4+0.01)
model <- lm(DIABETE4~., data = CDC_2023_training1) 
