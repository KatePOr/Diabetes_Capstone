...
# Function to normalize BMI column
```{r}
...
# Calculate test and training split
```{r}
...
# Normalize BMI in training and test sets
```{r}
columns = 19
...
# Check proportions of DIABETE4 in training and test sets
```{r}
